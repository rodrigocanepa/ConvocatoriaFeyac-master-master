...
public class WebsProductosSeccion5 extends AppCompatActivity {
        ...
        public DataConfigHolder(View itemView, Context ctx, final List<ItemFoto> itemFotos) {
            ...
            btnEliminar.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    adapter = new WebsProductosSeccion5.DataConfigAdapter(itemFotos, getApplicationContext());
            ...
            btnEditar.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final AlertDialog.Builder builder = new AlertDialog.Builder(WebsProductosSeccion5.this);
    ...
    private class DataConfigAdapter extends RecyclerView.Adapter<WebsProductosSeccion5.DataConfigHolder> {
        ...
        @Override
        public WebsProductosSeccion5.DataConfigHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = getLayoutInflater().inflate(R.layout.item_con_foto, parent, false);
            return new WebsProductosSeccion5.DataConfigHolder(view, ctx, itemFotos);
        }

        @Override
        public void onBindViewHolder(final WebsProductosSeccion5.DataConfigHolder holder, final int position) {
    ...
    private WebsProductosSeccion5.DataConfigAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_webs_productos_seccion5);

        recyclerView = (RecyclerView)findViewById(R.id.recyclerProductosSeccion5);
        ...
        addCaracteristica.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(itemFotoList.size() < 6){
                            ...
                            PickImageDialog.build(new PickSetup().setTitle("Escoge una opción")
                                    ...
                                    .setOnPickResult(new IPickResult() {
                                        ...
                                        public void onPickResult(PickResult r) {
                                            ...
                                            StorageReference refSubirImagen = storage.getReferenceFromUrl("gs://pyme-assistant.appspot.com/web/userid").child(nombre_web + itemFotoList.size() + 12);
                    ...
                    Toast.makeText(getApplicationContext(), "Sólo se permiten máximo 6 imagenes", Toast.LENGTH_LONG).show();
                }
        ...
        btnSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(itemFotoList.size() == 1){
                    ...
                    editor.putString("web_productos_seccion_5_caracteristica1_titulo", itemFotoList.get(0).getTitulo());
                    editor.putString("web_productos_seccion_5_caracteristica1_descripcion", itemFotoList.get(0).getDescripcion());
                    editor.putString("web_productos_seccion_5_caracteristica1_url", itemFotoList.get(0).getUrl());
                }
                    ...
                    editor.putString("web_productos_seccion_5_caracteristica1_descripcion", itemFotoList.get(0).getDescripcion());
                    editor.putString("web_productos_seccion_5_caracteristica1_url", itemFotoList.get(0).getUrl());
                    editor.putString("web_productos_seccion_5_caracteristica2_titulo", itemFotoList.get(1).getTitulo());
                    editor.putString("web_productos_seccion_5_caracteristica2_descripcion", itemFotoList.get(1).getDescripcion());
                    editor.putString("web_productos_seccion_5_caracteristica2_url", itemFotoList.get(1).getUrl());
                }
                    ...
                    editor.putString("web_productos_seccion_5_caracteristica5_descripcion", itemFotoList.get(4).getDescripcion());
                    editor.putString("web_productos_seccion_5_caracteristica5_url", itemFotoList.get(4).getUrl());
                }
                    ...
                    editor.putString("web_productos_seccion_5_caracteristica5_descripcion", itemFotoList.get(4).getDescripcion());
                    editor.putString("web_productos_seccion_5_caracteristica5_url", itemFotoList.get(4).getUrl());
                    editor.putString("web_productos_seccion_5_caracteristica6_titulo", itemFotoList.get(5).getTitulo());
                    editor.putString("web_productos_seccion_5_caracteristica6_descripcion", itemFotoList.get(5).getDescripcion());
                    editor.putString("web_productos_seccion_5_caracteristica6_url", itemFotoList.get(5).getUrl());
                }
                editor.commit();
                // ******************************************************************************
